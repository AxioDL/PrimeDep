...
class MapUniverse final
: public TypedResource('MAPU', ".mapuniverse", ".mapu", DESCRIPTION("Metroid Map Universe")) {
public:
  MapUniverse(const char* ptr, std::size_t size, const ResourceDescriptor32Big& desc);
