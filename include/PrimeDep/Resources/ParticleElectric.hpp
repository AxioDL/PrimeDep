...
class ParticleElectric final : public ITypedResource<FOURCC('ELSC'), "Particle Electric Data"> {
public:
  ParticleElectric(const char* ptr, std::size_t size, const ResourceDescriptor32Big& desc);
