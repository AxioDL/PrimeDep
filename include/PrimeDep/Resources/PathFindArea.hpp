...
class PathFindArea final
: public TypedResource('PATH', ".rawpath", ".path", DESCRIPTION("Path Find Area")) {
public:
  PathFindArea(const char* ptr, std::size_t size, const ResourceDescriptor32Big& desc);
