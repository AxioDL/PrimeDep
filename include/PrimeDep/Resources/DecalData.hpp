...
class DecalData final
: public TypedResource('DPSC', ".dpsm", ".dpsm.dpsc", DESCRIPTION("Decal Particle System")) {
public:
  DecalData(const char* ptr, std::size_t size, const ResourceDescriptor32Big& desc);
